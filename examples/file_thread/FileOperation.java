...
class FileController {
	...
	static void copyTextFile(String inputFile, String outputFile)  {
	...
	static void copyBinaryFile(String inputFile, String outputFile)  {
	 ...
	 * 
	 */
	static String fileSearch(String filename, String pathname) {
